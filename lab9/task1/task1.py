...
class Cars(pygame.sprite.Sprite):
    ...
    def build_coin(self, main_image):
        self.main_image = main_image
        pygame.draw.circle(self.main_image, "yellow", (self.rect_coin.center[0] + self.image_coin.get_rect().center[0], self.rect_coin.center[1] + self.image_coin.get_rect().center[1]), (6 - self.r_s) * 5)
        self.main_image.blit(self.image_coin, self.rect_coin.center)
    def create_rand_coin(self):
        self.rand_size = random.randint(1, 5)
        self.r_s = int(self.rand_size)
        self.font = pygame.font.SysFont("Verdana", 10 * (6 - self.rand_size))
        self.image_coin = self.font.render(str(self.rand_size), True, "blue")
        self.rect_coin = self.image_coin.get_rect()
